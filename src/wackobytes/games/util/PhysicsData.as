        ...
        var anchor:Vec2;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(8,6)   ,  Vec2.weak(8,11)   ,  Vec2.weak(34,31)   ,  Vec2.weak(41,28)   ,  Vec2.weak(13,5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(11,72)   ,  Vec2.weak(14,80)   ,  Vec2.weak(39,62)   ,  Vec2.weak(13,65)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(77,65)   ,  Vec2.weak(47,61)   ,  Vec2.weak(39,62)   ,  Vec2.weak(23,170)   ,  Vec2.weak(32,172)   ,  Vec2.weak(58,172)   ,  Vec2.weak(67,169)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(14,80)   ,  Vec2.weak(23,170)   ,  Vec2.weak(39,62)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(34,31)   ,  Vec2.weak(40,57)   ,  Vec2.weak(47,61)   ,  Vec2.weak(41,28)   ],
                            mat,
                            filt
                        );
                        s.body = body;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(6,53)   ,  Vec2.weak(8,58)   ,  Vec2.weak(14,59)   ,  Vec2.weak(97,50)   ,  Vec2.weak(93,38)   ,  Vec2.weak(90,32)   ,  Vec2.weak(10,50)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(100,29)   ,  Vec2.weak(92,12)   ,  Vec2.weak(73,5)   ,  Vec2.weak(33,8)   ,  Vec2.weak(14,15)   ,  Vec2.weak(9,37)   ,  Vec2.weak(10,50)   ,  Vec2.weak(90,32)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(95,67)   ,  Vec2.weak(100,53)   ,  Vec2.weak(97,50)   ,  Vec2.weak(14,59)   ,  Vec2.weak(17,68)   ,  Vec2.weak(37,71)   ,  Vec2.weak(78,71)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(6,37)   ,  Vec2.weak(9,37)   ,  Vec2.weak(14,15)   ,  Vec2.weak(8,21)   ,  Vec2.weak(4,31)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(7,41)   ,  Vec2.weak(10,50)   ,  Vec2.weak(9,37)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(96,38)   ,  Vec2.weak(93,38)   ,  Vec2.weak(97,50)   ],
                            mat,
                            filt
                        );
                        s.body = body;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(122,4)   ,  Vec2.weak(116,5)   ,  Vec2.weak(110,11)   ,  Vec2.weak(94,36)   ,  Vec2.weak(99,37)   ,  Vec2.weak(121,16)   ,  Vec2.weak(124,10)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(53,24)   ,  Vec2.weak(53,28)   ,  Vec2.weak(68,30)   ,  Vec2.weak(63,22)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(65,14)   ,  Vec2.weak(63,22)   ,  Vec2.weak(68,30)   ,  Vec2.weak(68,14)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(5,43)   ,  Vec2.weak(5,53)   ,  Vec2.weak(10,66)   ,  Vec2.weak(30,80)   ,  Vec2.weak(44,84)   ,  Vec2.weak(67,84)   ,  Vec2.weak(44,32)   ,  Vec2.weak(24,32)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(105,44)   ,  Vec2.weak(99,37)   ,  Vec2.weak(94,36)   ,  Vec2.weak(44,32)   ,  Vec2.weak(67,84)   ,  Vec2.weak(82,79)   ,  Vec2.weak(101,64)   ,  Vec2.weak(106,53)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(53,28)   ,  Vec2.weak(44,32)   ,  Vec2.weak(94,36)   ,  Vec2.weak(68,30)   ],
                            mat,
                            filt
                        );
                        s.body = body;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(57,34)   ,  Vec2.weak(53,15)   ,  Vec2.weak(46,7)   ,  Vec2.weak(4,44)   ,  Vec2.weak(11,52)   ,  Vec2.weak(23,57)   ,  Vec2.weak(47,51)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(8,10)   ,  Vec2.weak(1,24)   ,  Vec2.weak(4,44)   ,  Vec2.weak(46,7)   ,  Vec2.weak(36,2)   ,  Vec2.weak(22,2)   ],
                            mat,
                            filt
                        );
                        s.body = body;
